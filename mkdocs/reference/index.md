...
Quick access to API documentation, version history, roadmap, and deep-dive guides.
...
-   :material-file-document-multiple: __Deep Dive Documentation__
    Architecture guides, generator internals, incremental design decisions, and contributor resources.
