  - [23.44. v1.21.0 ✅](#2344-v1210-)
  - [23.45. v1.20.0 ✅](#2345-v1200-)
  - [23.46. v1.19.0 ✅](#2346-v1190-)
  - [23.47. v1.18.0 ✅](#2347-v1180-)
  - [23.48. v1.17.0 ✅](#2348-v1170-)
  - [23.49. v1.16.0 ✅](#2349-v1160-)
  - [23.50. v1.15.0 ✅](#2350-v1150-)
  - [23.51. v1.14.x ✅](#2351-v114x-)
  - [23.52. v1.13.0 ✅](#2352-v1130-)
...
```xml
<ItemGroup>
  <PackageReference Include="REslava.Result" Version="1.52.0" />
  <PackageReference Include="REslava.Result.Analyzers" Version="1.52.0" />

  <!-- OPTIONAL — only for ASP.NET Core projects.
       Source generators: SmartEndpoints, [Validate], OneOfToIResult. -->
  <PackageReference Include="REslava.Result.AspNetCore" Version="1.52.0" />

  <!-- OPTIONAL — pipeline diagram generator (REslava.Result-native).
       Full type travel + typed error surface inference. Requires REslava.Result. -->
  <PackageReference Include="REslava.Result.Flow" Version="1.52.0" />

  <!-- OPTIONAL — pipeline diagram generator (library-agnostic).
       Works with any Result library (ErrorOr, LanguageExt, etc.). No REslava.Result dependency. -->
  <PackageReference Include="REslava.ResultFlow" Version="1.52.0" />

  <!-- OPTIONAL — HTTP client extensions: wrap HttpClient calls as typed Result<T> -->
  <PackageReference Include="REslava.Result.Http" Version="1.52.0" />
  ...
  <PackageReference Include="REslava.Result.OpenTelemetry" Version="1.52.0" />

  <!-- OPTIONAL — VSIX Live panel (v1.52.0+). Exposes RingBufferObserver via HTTP so the
  ...
  <PackageReference Include="REslava.Result.Diagnostics" Version="1.52.0" />
  ...
  -->
  <PackageReference Include="REslava.Result.FluentValidation" Version="1.52.0" />
</ItemGroup>
```
...
### 3.27. 🔬 Pipeline Runtime Observation — `RingBufferObserver` + `_Traced` (v1.52.0)
...
**VSIX Live panel — `▶ Debug` CodeLens (v1.52.0):**

The `REslava.Result Extensions` VS Code extension adds a `▶ Debug` CodeLens above every `[ResultFlow]` method. Clicking it opens a Live panel that polls your app's trace endpoint and streams execution data — trace list, node stepper, and animated replay — directly into VS Code.

Four playback modes:

| Mode | Description |
|---|---|
| **📋 History** | Ring buffer replay — last N executions, scrollable list |
| **🎯 Single** | Latest run only; auto-replaces on each new execution |
| **⏭ Step** | Node-by-node stepper with Prev / Next controls |
| **🔁 Replay** | Animated full-speed replay (400 ms per node) |

**Bridge the app to the Live panel with `REslava.Result.Diagnostics`:**

```bash
dotnet add package REslava.Result.Diagnostics
```

For **console / worker apps** — start a standalone Kestrel endpoint:
...
// GET http://localhost:5297/reslava/traces  ← Live panel polls here
```

For **ASP.NET Core apps** — map the route into your existing `WebApplication`:
