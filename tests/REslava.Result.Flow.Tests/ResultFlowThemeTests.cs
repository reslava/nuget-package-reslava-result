...
/// <summary>
/// Tests for Light/Dark theme emission in ResultFlowMermaidRenderer.
/// Covers: theme block content, MermaidInit, subgraph class assignments, linkStyle.
/// </summary>
[TestClass]
public class ResultFlowThemeTests
{
    ...
    public void Render_MermaidInit_AppearsBeforeFlowchart()
    {
        ...
        // Must also appear after frontmatter
    ...
    {
        var output = ResultFlowMermaidRenderer.Render(SimpleChain());
        // classDef subgraphStyle is always present (in theme block) but no class sg_* line
