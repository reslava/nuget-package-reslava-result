...
{
    /// <summary>
    /// Generates OneOf2ToIResult extension methods - FIXED
    /// </summary>
    public class OneOf2ToIResultExtensionGenerator : ICodeGenerator
    {
        public SourceText GenerateCode(Compilation compilation, object config)
        {
            ...
            builder.AppendLine("    /// Extension methods for converting OneOf to IResult.");
            builder.AppendLine("    /// </summary>");
            builder.AppendLine("    public static class OneOf2Extensions");
            builder.AppendLine("{");
            
            // FIX: Add generic type parameters <T1, T2>
