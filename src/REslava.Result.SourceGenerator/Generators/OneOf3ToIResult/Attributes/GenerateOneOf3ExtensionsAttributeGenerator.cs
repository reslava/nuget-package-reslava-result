...
namespace REslava.Result.SourceGenerators.Generators.OneOf3ToIResult.Attributes
{
    /// <summary>
    /// Generates the GenerateOneOf3Extensions attribute.
    /// Single Responsibility: Only generates this specific attribute.
    /// </summary>
    public class GenerateOneOf3ExtensionsAttributeGenerator : IAttributeGenerator
    {
...
namespace REslava.Result.SourceGenerators.OneOf3
{
    /// <summary>
    /// Enables automatic generation of extension methods for converting OneOf&lt;T1,T2,T3&gt; to Microsoft.AspNetCore.Http.IResult with proper HTTP status codes and ProblemDetails.
    /// Generated by REslava.Result.SourceGenerators for OneOf3ToIResult.
    /// </summary>
    [AttributeUsage(AttributeTargets.Assembly, AllowMultiple = false)]
    public class GenerateOneOf3ExtensionsAttribute : Attribute
    {
        /// <summary>
