...
namespace REslava.Result.SourceGenerators.Generators.OneOf3ToIResult.CodeGeneration
{
    ...
    public class OneOf3ToIResultExtensionGenerator : ICodeGenerator
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("🔥 OneOf3ToIResultExtensionGenerator.GenerateCode called!");
            ...
            builder.AppendLine("        /// </summary>");
            builder.AppendLine("        public static IResult ToIResult(this OneOf<T1, T2, T3> oneOf)");
            builder.AppendLine("        {");
            ...
            System.Diagnostics.Debug.WriteLine("🔥 OneOf3ToIResultExtensionGenerator.GenerateCode completed!");
            return result;
        }
    }
}
