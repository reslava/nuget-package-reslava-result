...
namespace REslava.ResultFlow.Analyzers
{
    ...
    /// a Code Action that inserts the Mermaid diagram as a block comment above the method —
    /// no build required to view the diagram.
    /// </summary>
...
#pragma warning restore RS2008
        ...
        private static void AnalyzeMethod(SyntaxNodeAnalysisContext context)
        {
            ...
            // Try to extract the chain — pure syntax, no semantic model needed
            var chain = ResultFlowChainExtractor.Extract(method);
