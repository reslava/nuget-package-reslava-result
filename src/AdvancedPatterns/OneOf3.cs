...
namespace REslava.Result.AdvancedPatterns
{
    ...
    /// - File operations: Read, Write, Delete results
    /// </para>
    /// <example>
    /// <code>
    ...
    public readonly struct OneOf<T1, T2, T3> : IEquatable<OneOf<T1, T2, T3>>
    {
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown when the OneOf contains T2 or T3.</exception>
        public T1 AsT1 => _index == 0 ? _value1 : throw new InvalidOperationException("OneOf contains T2 or T3, not T1");

        /// <summary>
        /// Gets the value as T2 if it contains T2, otherwise throws InvalidOperationException.
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown when the OneOf contains T1 or T3.</exception>
        public T2 AsT2 => _index == 1 ? _value2 : throw new InvalidOperationException("OneOf contains T1 or T3, not T2");

        /// <summary>
        /// Gets the value as T3 if it contains T3, otherwise throws InvalidOperationException.
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown when the OneOf contains T1 or T2.</exception>
        public T3 AsT3 => _index == 2 ? _value3 : throw new InvalidOperationException("OneOf contains T1 or T2, not T3");

        /// <summary>
        /// Private constructor for internal use.
        /// </summary>
        private OneOf(T1 value1, T2 value2, T3 value3, byte index)
        {
            _value1 = value1;
            _value2 = value2;
            _value3 = value3;
        ...
        {
            return new OneOf<T1, T2, T3>(value, default!, default!, 0);
        }
        ...
        {
            return new OneOf<T1, T2, T3>(default!, value, default!, 1);
        }
        ...
        {
            return new OneOf<T1, T2, T3>(default!, default!, value, 2);
        }
        ...
        /// <remarks>
        /// Match provides a type-safe way to handle all three possible cases without casting.
        ...
        {
            return HashCode.Combine(_index, _value1, _value2, _value3);
        }
