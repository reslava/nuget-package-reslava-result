...
![Architecture layer view — Application → Domain layers, color-coded subgraphs](https://raw.githubusercontent.com/reslava/nuget-package-reslava-result/main/images/OrderService_PlaceOrderCross_LayerView.svg)

**Error propagation** — errors grouped by the layer they originate from:

![Error propagation by layer](https://raw.githubusercontent.com/reslava/nuget-package-reslava-result/main/images/OrderService_PlaceOrderCross_ErrorPropagation.svg)

**Match** — hexagon node with typed N-branch fan-out:

![Match multi-branch fan-out — hexagon node with one typed error edge per branch](https://raw.githubusercontent.com/reslava/nuget-package-reslava-result/main/images/MatchDemo_ConfirmOrder.svg)
...
![Dark theme — cross-method pipeline with dark classDef palette](https://raw.githubusercontent.com/reslava/nuget-package-reslava-result/main/images/FulfillmentService_FulfillOrder.svg)
