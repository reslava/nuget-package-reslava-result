...
<p align="center">
  <a href="https://github.com/reslava/nuget-package-reslava-result#3--resultflow--mermaid-diagrams-autogenerated">
    <img src="https://raw.githubusercontent.com/reslava/nuget-package-reslava-result/main/images/diagram-cross-method-tracing.svg" width="700" />
  </a>
</p>
<p align="center"><em>Cross-method pipeline tracing — <code>[ResultFlow(MaxDepth = 2)]</code> expands <code>Bind</code> lambdas into named subgraphs</em></p>

<p align="center">
  <a href="https://github.com/reslava/nuget-package-reslava-result#3--resultflow--mermaid-diagrams-autogenerated">
    <img src="https://raw.githubusercontent.com/reslava/nuget-package-reslava-result/main/images/diagram-match-n-branch-fan-out.svg" width="700" />
  </a>
</p>
<p align="center"><em>Match multi-branch fan-out — hexagon node with one typed <code>-->|ErrorType| FAIL</code> edge per branch</em></p>

<p align="center"><a href="https://github.com/reslava/nuget-package-reslava-result#3--resultflow--mermaid-diagrams-autogenerated">→ Full diagram gallery and documentation on GitHub</a></p>
