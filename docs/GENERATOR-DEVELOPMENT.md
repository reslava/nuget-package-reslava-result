...
// ❌ Bad: No defaults or poor defaults
...
```csharp
// ✅ Good: Use incremental providers properly
...
// ❌ Bad: Generate on every compilation
public void Initialize(IncrementalGeneratorInitializationContext context)
{
...
```csharp
// ✅ Good: Use StringBuilder and pooling
...
```
MyGenerator/
├── MyGenerator.csproj              # Project file
├── MyGenerator.cs                  # Main generator class
├── MyGeneratorConfig.cs            # Configuration class
├── MyGeneratorAttribute.cs         # Assembly attribute
├── Tests/                          # Test project
│   ├── MyGeneratorTests.cs         # Unit tests
│   ├── MyGeneratorIntegrationTests.cs # Integration tests
│   └── TestModels.cs               # Test data
