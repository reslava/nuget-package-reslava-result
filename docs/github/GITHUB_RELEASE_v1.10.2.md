...
|---------|---------|-----------|------------|
| **REslava.Result** | ![NuGet Version](https://img.shields.io/nuget/v/REslava.Result) | ![NuGet Downloads](https://img.shields.io/nuget/dt/REslava.Result) | [📦 View on NuGet](https://www.nuget.org/packages/REslava.Result/1.10.2) |
| **REslava.Result.SourceGenerators** | ![NuGet Version](https://img.shields.io/nuget/v/REslava.Result.SourceGenerators) | ![NuGet Downloads](https://img.shields.io/nuget/dt/REslava.Result.SourceGenerators) | [📦 View on NuGet](https://www.nuget.org/packages/REslava.Result.SourceGenerators/1.10.2) |
