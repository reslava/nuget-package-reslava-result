...
///
/// Note: All validation errors (price, stock, required fields) are now
/// a single ValidationError type with different FieldName values.
/// This simplifies OneOf from OneOf4 to OneOf3 and OneOf3 to OneOf2.
/// </summary>
