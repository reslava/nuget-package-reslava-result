...
namespace REslava.Result.SourceGenerators.Generators.OneOf2ToIResult.CodeGeneration
{
    ...
    public class OneOf2ToIResultExtensionGenerator : ICodeGenerator
    {
        public SourceText GenerateCode(Compilation compilation, object config)
        {
            ...
            builder.AppendLine("        /// Error types → 400/401/403/404/409/500, Success types → 200/201");
            builder.AppendLine("        /// </summary>");
            ...
            builder.AppendLine("            ");
            builder.AppendLine("            // Validation Errors → 400 Bad Request");
            ...
            builder.AppendLine("                ");
            builder.AppendLine("            // Not Found Errors → 404 Not Found");
            ...
            builder.AppendLine("                ");
            builder.AppendLine("            // Conflict Errors → 409 Conflict");
            ...
            builder.AppendLine("                ");
            builder.AppendLine("            // Authorization Errors → 401 Unauthorized");
